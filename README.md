...
**NOTE**: Use treesitter version 0.25.x, as emacs (including 30.2) has problems with the 0.26 branch. For example, queries are
...
cases which frequently happen during typing. Lines witin incomplete and unfinished blocks are mostly correctly inlined.
...
everything execpt for about three lines is indented.
